	...
	<div class="container-fluid topmost-container" id="div-1"
		...
		<div class="row">
			<div class="test-board-header">
				...
				<div class="col-xs-12 col-sm-8 heading-div">
					<h2 class="heading">Talent Hunt Test</h2>
				</div>
		...
		<div id="cc-div-content" class="row">
			...
			<div class="row test-board-alternative">
				<div class="col-sm-12">
					...
					<span id="opt-a" class="test-board-option">Very true</span>
				</div>
			</div>
			<div class="row test-board-alternative">
				<div class="col-sm-12">
					<input type="radio" name="opt" class="opt" id="opt-2" value="2" />
					<span id="opt-b" class="test-board-option">Slightly true</span>
				</div>
			</div>
			<div class="row test-board-alternative">
				<div class="col-sm-12">
					<input type="radio" name="opt" class="opt" id="opt-1" value="1" />
					<span id="opt-c" class="test-board-option">Not true</span>
				</div>
			</div>
		...
		<div class="modal-dialog modal-sm">
			<div class="modal-content">
				...
				<div class="modal-body">
					<div class="row">
						<div class="col-sm-12">
							<h3 style="color: 	#983b59; font-family: tahoma">END TEST?</h3>
							<p>
