...
<title>Career Cluster Test</title>
...
<body style="padding-top: 0px; height: 100%;" id="body" class="test-grad" >
		...
		<div class="row">
			<div class="test-board-header">
				...
				<div class="col-xs-12 col-sm-8 heading-div" style="height: 4.5em">
					<h2 class="heading">Career Cluster Test</h2>
				</div>
		...
		<div id="cc-div-content" class="row">
			...
			<div class="row test-board-alternative">
				<div class="col-sm-12">
					...
					<span id="opt-a" class="test-board-option">Very true about
						me</span>
				</div>
			</div>
			<div class="row test-board-alternative">
				<div class="col-sm-12">
					...
					<span id="opt-b" class="test-board-option">True about me</span>
				</div>
			</div>
			<div class="row test-board-alternative">
				<div class="col-sm-12">
					<input type="radio" name="opt" class="opt" id="opt-2" value="2" />
					<span id="opt-c" class="test-board-option">Not so true about
						me</span>
				</div>
			</div>
			<div class="row test-board-alternative">
				<div class="col-sm-12">
					...
					<span id="opt-d" class="test-board-option">False</span>
				</div>
			</div>
	...
	<!-- career cluster description modal -->
	<div id="description-dialog" class="modal fade" tabindex="-1"
	...
	<script type="text/javascript" src="/js/careerclusters.js"></script>
